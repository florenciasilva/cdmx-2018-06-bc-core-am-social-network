...
const userNickname = document.getElementById('icon_prefix');
const userEmail = document.getElementById('icon_email');
const userPassword = document.getElementById('icon_vpn_key');
// HTML Elements for Sign In/Out
const btnSignIn = document.getElementById('btnSignIn');
const userEmailSignIn = document.getElementById('icon_email_sign_in');
